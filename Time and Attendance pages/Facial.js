...
import iface301 from "../Images/iface301.jpg";
import iface302 from "../Images/iface302.jpg"
import vf300 from "../Images/vf300.jpg"
...
<div class="row row-cols-1 row-cols-md-3 g-4 container">
 <div class="col">
     ...
     <img src={iface301} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center">iFace301</h4>
         <p class="card-text">iFace301 multi-biometric identification time attendance and access control terminal a Face 7.0 algorithm and large capacity memory. iFace series integrated with high speed Multi-Bio processor and high definition infrared camera enables user identification in the dark environment.</p>
         <Link to="/iface301"><button id="smartbtn">Read more</button></Link>
     </div>
 ...
 <div class="col">
     <div class="card h-100">
     <img src={iface302} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center">iFace302</h4>
         <p class="card-text">With iFace 302, users can identify or verify themselves either by face, finger, ID card or PIN/password. The TFT color touch screen of iFace 302 provides ease of use and a rich user experience. The iFace 302 uses state of the art 3D imaging technology while also providing hygienic 100% touch-free biometric authentication.</p>
         <Link to="/iface302"><button id="smartbtn">Read more</button></Link>
     </div>
 ...
 <div class="col">
     <div class="card h-100">
     <img src={vf300} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center">VF300</h4>
         <p class="card-text">VF 300 is the least intrusive and fastest biometric technology. It is hygienic and 100% touch free biometric authentication. It works with the most obvious individual identifier – the human face. Facial recognition analyzes the characteristics of a person’s face images input through a digital video camera.</p>
         <Link to="/vf300"><button id="smartbtn">Read more</button></Link>
     </div>
