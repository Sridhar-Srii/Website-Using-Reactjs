...
import k200 from "../Images/k200.jpg"
import s300 from "../Images/s300.jpg"
import s680 from "../Images/s680.jpg"
...
{/* Navbar Ends */}
       ...
       <div className="card"> 
<br></br>
<h1 className="text-center">Smart Card Reader</h1>
...
<div class="row row-cols-1 row-cols-md-3 g-4 container">
 <div class="col">
     ...
     <img src={k200} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center">K200</h4>
         <p class="card-text">K200 is a card based time and attendance system. It has a capacity of 30,000 cards and 50,000 transaction. This device can read card from 8 – 10 cm distance. With identification speed of less than 1 sec it will help reduce time and avoid long queue. This device will help organizations to reduce.</p>
     </div>
 ...
 <div class="col">
     <div class="card h-100">
     <img src={s300} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center">S300</h4>
         <p class="card-text">S300 is an innovative proximity card reader for time and attendance applications. S300 comes standard with TCP/IP and RS-232 communication ports. An optional USB port allows administrator to transfer data when network isn’t available. SDK is available for OEM and software developers. S300 is a feature-rich yet low-priced proximity terminal which match the capabilities to.</p>
     </div>
 ...
 <div class="col">
     <div class="card h-100">
     <img src={s680} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center">S680</h4>
         <p class="card-text">S680 is an innovative versatile time clock which combines a highly durable yet elegant casing with a variety of card readers and available in linux and windows CE platform. Programmers will appreciate S680 available development platforms which include Linux, WinCE v6.0 and Python. S680 installs easily on your network an supports both hard-wired TCP/IP</p>
     </div>
