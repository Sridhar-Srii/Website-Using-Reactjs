...
<h1 className="text-center m-auto">Services</h1>
<br></br>
</div>
        ...
        <div class="row g-0 container m-auto" data-aos="fade-up" data-aos-duration="1500">
            ...
            <div class="col-md-4 col-lg-4 col-sm-4" id="gasimg">
