...
{/* Navbar Ends */}
        ...
        <div class="row g-0 container m-auto">
            <h1 className="text-center">RFID Inventory Tracking</h1> <br></br>
            <div class="col-md-6 col-lg-6 col-sm-6" >
            <div class="card-body">
                <p class="card-text" id="time">With today’s demand for leaner, faster, supply chains, conventional manual based systems are too labour intensive, time consuming and error-prone. RFID Inventory tracking solution alleviates these challenges by providing businesses with the ability to track the location at item, crate, pallet or conveyor level and maintain count of inventory at all stages of the supply chain, in real time. The flow of data made accessible by implementing RFID, allows businesses to perform tasks and make urgent managerial decisions, that were traditionally too complex, quicker. Automatic replenishment reports allow for prompt stock turn over, and support Just-In-Time management practices. This solution offers a number of benefits over traditional manual based systems, including; Item Level Tracking – Allows businesses to automate receiving, picking and ordering and also control shrinkage and loss. Automate Data Collection – RFID enables businesses to have increased reporting accuracy, allowing better stock management, sales floor replenishment and improved customer satisfaction Streamline Warehouse Processes – Accurate real time data allowing businesses to operate more efficiently and reducing labour costs and also enabling “omni-channel” strategy to streamline the ship from store process.</p>
                <br></br>
            </div>
            </div>
            <div class="col-md-4 col-lg-4 col-sm-4" id="timeimg">
            {/* <img src={pay} class="img-fluid rounded-start" alt="..."></img> */}
            <img src={inventorytracking} class="d-block w-100" alt="..."></img>
            <h3>Inventory tracker’s most common application areas include:</h3>
            <p>Warehousing | Manufacturing | Healthcare
Retail Showroom | Construction | Hiring supplies</p>
