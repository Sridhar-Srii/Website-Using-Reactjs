...
{/* Navbar Ends */}
        ...
        <div class="row g-0 container m-auto">
            <h1 className="text-center">RFID Asset Tracking</h1> <br></br>
            <div class="col-md-6 col-lg-6 col-sm-6" >
            <div class="card-body">
                <p class="card-text" id="time">RFID Asset Tracking Solutions provide businesses with the ability to seamlessly identify and track key assets and inventory items, leading to higher levels of visibility and process efficiency. RFID tags are attached to items and a combination of fixed and mobile infrastructure is used to deliver current location and status data. Asset Maintenance – Performing scheduled services and ensuring maintenance history is updated to reduce time and cost associated with typical process. Process Automation – RFID technology is used to leverage location and status data, to automate workflow operations. Asset Security – Alerts are generated when unauthorised activity is detected. Alerts can take the form of an alarm, a flash light or an email. Condition Monitoring – Gauge environmental parameters (temperature, pressure, humidity, vibration) of key items to prevent spoil. Utilising active RFID technology with external sensors to monitor a parameter or condition, it allows maintenance to be scheduled, or a notification to be sent if there is a significant change or a developing failure. Item Accountability – Personnel & items are both tagged to record the identity of the employee performing the tasks, to provide better accountability.</p>
                <br></br>
            </div>
            </div>
            <div class="col-md-4 col-lg-4 col-sm-4" id="timeimg">
            {/* <img src={pay} class="img-fluid rounded-start" alt="..."></img> */}
            <img src={assettracking} class="d-block w-100" alt="..."></img>
            <h3>Asset tracker’s most common application areas include:</h3>
            <p>Offices | Warehousing | Manufacturing
               Data Centres | Healthcare | Hiring supplies
