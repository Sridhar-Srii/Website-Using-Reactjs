...
{/* Navbar Ends */}
        ...
        <div class="row g-0 container m-auto">
            <h1 className="text-center">iF301</h1> <br></br>
            <div class="col-md-6 col-lg-6 col-sm-6" >
            <div class="card-body">
                <p class="card-text" id="iface">iFace301 multi-biometric identification time attendance and access control terminal a Face 7.0 algorithm and large capacity memory. iFace series integrated with high speed Multi-Bio processor and high definition infrared camera enables user identification in the dark environment. Face and fingerprint multi-biometric identification method will be applicable more widely. All operations of iFace are designed to be performed on the 4.3 inches TFT touch screen. Multi-model communications includes RS232/485, TCP/IP, optional WiFi or GPRS. Optional built-in 2000 mAh battery eliminates the trouble of power-failure.</p>
                <br></br>
            </div>
            </div>
            <div class="col-md-4 col-lg-4 col-sm-4" id="ifaceimg">
            {/* <img src={pay} class="img-fluid rounded-start" alt="..."></img> */}
            <img src={iface301} class="d-block w-100" alt="..."></img>
...
<div className="card">
            ...
            <tbody>
                ...
                <tr>
                <th scope="row">USB-HOST</th>
                <td>Two USB-Host</td>
                </tr>

                <tr>
                <th scope="row">Wireless Wi-Fi</th>
                <td>Optional</td>
