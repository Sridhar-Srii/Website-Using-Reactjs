...
{/* Navbar Ends */}
        ...
        <div class="row g-0 container m-auto">
            <h1 className="text-center">VF300</h1> <br></br>
            <div class="col-md-6 col-lg-6 col-sm-6" >
            <div class="card-body">
                <p class="card-text" id="iface">VF 300 is the least intrusive and fastest biometric technology. It is hygienic and 100% touch free biometric authentication. It works with the most obvious individual identifier – the human face. Facial recognition analyzes the characteristics of a person’s face images input through a digital video camera. VF 300 is updated with simple technology and it is user friendly. It can also access ID cards, passwords. By recognition of the face of employee it generates attendance of employees and finally it will help organizations to maintain pay roll of employees.</p>
                <br></br>
            </div>
            </div>
            <div class="col-md-4 col-lg-4 col-sm-4" id="ifaceimg">
            {/* <img src={pay} class="img-fluid rounded-start" alt="..."></img> */}
            <img src={vf300} class="d-block w-100" alt="..."></img>
        ...
        <div className="card">
            ...
            <tbody>
                ...
                <td>Special Sterio Dual Sensor</td>
