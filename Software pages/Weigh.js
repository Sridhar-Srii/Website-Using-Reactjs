...
import weigh4 from "../Images/weigh4.jpg"
import weigh5 from "../Images/weigh5.jpg"
...
<h1 className="text-center m-auto">eWeigh</h1>
<br></br>
</div>
...
{/* Weigh ends */}
        ...
        <div class="row g-0 container m-auto" data-aos="fade-up" data-aos-duration="1500">
            <h1 className="text-center">Batch Weighing Facility</h1> <br></br>
            <div class="col-md-4 col-lg-4 col-sm-4" id="weigh2img">
        ...
        <div id="carouselExampleFade4" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                <img src={weigh4} class="d-block w-100" alt="..."></img>
                </div>
                <div class="carousel-item">
                <img src={weigh5} class="d-block w-100" alt="..."></img>
                </div>
            ...
            <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleFade4" data-bs-slide="next">
                ...
                <div class="col-md-7 col-lg-7 col-sm-7 " >
                        <div class="card-body">
                            <p class="card-text" id="weigh2">Take Batch Tare/ Gross weight for single truck – use ware house. Provide Dropdown Feature For Party Master, Vehicle Master, Product Master. View live Vehicle position with CCTV & Capture photo, also print ticket with vehicle photo. Facility for select automatically vehicle tare weight. Customize and Develop As per Client Requirement and connect with SAP/ ERP/ Oracle </p>
                            <br></br>
                        </div>
                        </div>
                        <br></br>
