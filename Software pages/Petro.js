...
import petrol4 from "../Images/petrol4.jpg"
import petrol5 from "../Images/petrol5.jpg"
import petrol6 from "../Images/petrol6.jpg"
import petrol7 from "../Images/petrol7.jpg"
import petrol8 from "../Images/petrol8.jpg"
import petrol9 from "../Images/petrol9.jpg"
...
<h1 className="text-center m-auto">ePetro</h1>
<br></br>
</div>
        ...
        {/* Billing & Accounting starts */}


        {/* <div class="card" >  */}
        <br></br>
        <div class="row g-0 container m-auto" data-aos="fade-up" data-aos-duration="1500">
            <h1 className="text-center">Billing and Accounting</h1> <br></br>
            <div class="col-md-4 col-lg-4 col-sm-4" id="billimg">
            ...
            <div id="carouselExampleFade8" class="carousel slide carousel-fade" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                    <img src={petrol4} class="d-block w-100" alt="..."></img>
                    </div>
                    <div class="carousel-item">
                    <img src={petrol5} class="d-block w-100" alt="..."></img>
                    </div>
            ...
            <div class="card-body">
                <p class="card-text" id="bill">Billing and accounting is primary in every petrol pump, which is quite a daunting task. With ePetro petrol pump billing and accounting software one can easily have a control on these tasks. This software comes with a strong configuration that allows you to suit the requirements of varied petrol bunks.</p>
                <br></br>
            </div>
            </div>
            <br></br>
      ...
      {/* </div> */}
        ...
        <br></br>
        <div class="row g-0 container m-auto" data-aos="fade-up" data-aos-duration="1500">
            <h1 className="text-center">Inventory Control</h1> <br></br>
            <div class="col-md-6 col-lg-6 col-sm-6" >
            <div class="card-body">
                <p class="card-text" id="inventory">This module keeps an eye on your inventory and enables you to maintain the stock of your pump. It helps you to maintain Stock valuation; Stock Summary as well as Stock Ledger & related reports that will help you evaluate the stock of fuel, lube and other items in your inventory.</p>
            </div>
            </div>
            <div class="col-md-4 col-lg-4 col-sm-4" id="inventoryimg">
            {/* <img src={pay} class="img-fluid rounded-start" alt="..."></img> */}
            <div id="carouselExampleFade3" class="carousel slide carousel-fade" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                    <img src={petrol6} class="d-block w-100" alt="..."></img>
                    </div>
                    <div class="carousel-item">
                    <img src={petrol7} class="d-block w-100" alt="..."></img>
                    </div>
        ...
        <br></br>
        <div class="row g-0 container m-auto" data-aos="fade-up" data-aos-duration="1500">
            <h1 className="text-center">Sales Management</h1> <br></br>
            <div class="col-md-4 col-lg-4 col-sm-4" id="saleimg">
            {/* <img src={emines} class="img-fluid rounded-start" alt="..."></img> */}
            <div id="carouselExampleFade4" class="carousel slide carousel-fade" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                    <img src={petrol8} class="d-block w-100" alt="..."></img>
                    </div>
                    <div class="carousel-item">
                    <img src={petrol9} class="d-block w-100" alt="..."></img>
                    </div>
            ...
            <div class="col-md-7 col-lg-7 col-sm-7 " >
            <div class="card-body">
                <p class="card-text" id="sale">Amongst the wide variety of facilities that this petrol bunk management software offers, managing the sales of the petrol pump is another major task that one can handle with this management software. ePetro comes with a well-organized credit management system, which provides the option of outstanding payments and credit bills. We are proud to say that the software we provide to our customers is unique, and we also assure you that our thirst for constant upgradation and development with never take a pause.</p>
                <br></br>
            </div>
            </div>
            <br></br>
