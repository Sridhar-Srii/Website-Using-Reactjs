...
import s990 from "../Images/s990.jpg"
import k990 from "../Images/k990.jpg"
import sc405 from "../Images/sc405.jpg"
...
<h1 className="text-center">A Smartcard Reader</h1>
...
<div class="row row-cols-1 row-cols-md-3 g-4 container">
 <div class="col">
     ...
     <img src={s990} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center">S990</h4>
         <p class="card-text">S990 is a RFID identification T&A and access control terminal which has a capacity of 10,000 cards and 1, 00,000 transaction logs with fastest identification speed of less than or equal to 0.1 second. The wiegand-in interface is used to connect external reader to construct master and slave system.</p>
     </div>
 ...
 <div class="col">
     <div class="card h-100">
     <img src={k990} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center">K990</h4>
         <p class="card-text">K990 is a card based time attendance and access control terminal. It has a capacity of 1,00,000 cards and transaction logs with fastest identification speed of less than or equal to 0.1 second. The wiegand-in interface is used to connect external reader to construct master and slave system.</p>
     </div>
 ...
 <div class="col">
     <div class="card h-100">
     <img src={sc405} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center">SC405</h4>
         <p class="card-text">SC405 is a professional access control terminal, specially designed for the international high terminal access control market to substitute multi door controller concept.Our SC Series products are the next evolution in access control hardware solutions. A true IP solution that meets the demands of open architecture.</p>
     </div>
...
export default Accesssmartcard;