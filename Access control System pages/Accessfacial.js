...
import multibio700 from "../Images/multibio700.jpg"
import vf380 from "../Images/vf380.jpg"
import biocam300 from "../Images/biocam300.jpg"


function Accessfacial () {
...
<h1 className="text-center">Facial Recognition Systems</h1>
...
<div class="row row-cols-1 row-cols-md-3 g-4 container">
 <div class="col">
     ...
     <img src={multibio700} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center">MultiBio 700</h4>
         <p class="card-text">MultiBio700 is a new generation multiple biometric identification product with Face, Fingerprint, PIN recognition and optional RFID mode. It allows up to 20 verification methods, all conveniently from a single device. MultiBio700 stores 1500 face and 2000 fingerprint templates and identify users by 1:N mode.</p>
     </div>
 ...
 <div class="col">
     <div class="card h-100">
     <img src={vf380} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center">VF380</h4>
         <p class="card-text">VF380 is a face recognition time and attendance and access control system which can connect with 3rd party electric lock, door sensor and exit button. Multimodal identification of Face, PIN and RFID are available. Infra-red optical system enables user-identification in poorly lit environment. Communication to PC is through Ethernet.</p>
     </div>
 ...
 <div class="col">
     <div class="card h-100">
     <img src={biocam300} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center mt-3">Biocam300</h4>
         <p class="card-text">Biocam300 is the world’s first HD IP camera with embedded facial recognition and display in a single unit. Using latest facial recognition algorithm, it can identify users from a database of 400 faces in less than one second. Users can be identified from a distance of 12.5 feet with built-in IR light source.</p>
     </div>
