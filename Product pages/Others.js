...
import L7000 from "../Images/L7000.jpg"
import LH1000 from "../Images/LH1000.jpg"
import LH4000 from "../Images/LH4000.jpg"
import L5000 from "../Images/L5000.jpg"
import T351  from "../Images/T351.jpg"
...
<h1 className="text-center m-auto">Other Accessories & Components</h1>
<br></br>
</div>
       ...
       <div className="card"> 
<br></br>
<h1 className="text-center">Other Accessories & Components</h1>
...
<div class="row row-cols-1 row-cols-md-3 g-4 container">
 <div class="col">
     ...
     <img src={L7000} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center">L7000</h4>
         <p class="card-text">The fingerprint lock offers state-of-the-art single door management solution that provides you with unmatched options that comes with OLED. You can verify a person and open the door with fingerprint and password. The All-in-one fingerprint lock is very convenient to operate & enrollment of users.</p> <br></br>
         {/* <button id="smartbtn">Read more</button> */}
     </div>
 ...
 <div class="col">
     <div class="card h-100">
     <img src={LH1000} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center">LH1000</h4>
         <p class="card-text">The intelligent hotel lock system offers standalone solution to meet hotel’s demand on security and management. The style and color of lock fit any type of hotel. With the hotel management software, hotels can perform essential management tasks quickly and easily with minimal training.</p> <br></br>
         {/* <button id="smartbtn">Read more</button> */}
     </div>
 ...
 <div class="col">
     <div class="card h-100">
     <img src={LH4000} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center">LH4000</h4>
         <p class="card-text">The intelligent hotel lock system offers standalone solution to meet hotel’s demand on security and management, which features 13.56MHz Mifare card technology and hotel management software. The body of lock is made by zinc alloy which is strong enough to protect the system from any considerable outside impact.</p>
         {/* <button id="smartbtn">Read more</button> */}
     </div>
 ...
 <div class="col">
     <div class="card h-100">
     <img src={L5000} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center">L5000</h4>
         <p class="card-text">The fingerprint lock offers state-of-the-art single door management solution that provides you with unmatched options that comes with OLED, Standard USB interface. You can verify a person and open the door with fingerprint, password and ID/Mifare cards. The All-in-one fingerprint lock is very convenient to operate.</p>
         {/* <button id="smartbtn">Read more</button> */}
     </div>
 ...
 <div class="col">
     <div class="card h-100">
     <img src={T351} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center">351T</h4>
         <p class="card-text">Single door electric lock is for glass door, wooden door, small size door, easy to install. Accessories are available for inswing door, glass door, narrow doorframe door etc., Anti-residual magnetism designed makes the access control automate.</p> <br></br> <br></br>
         {/* <button id="smartbtn">Read more</button> */}
     </div>
