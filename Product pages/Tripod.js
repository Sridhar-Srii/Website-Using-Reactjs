...
import Ts1000 from "../Images/Ts1000.jpg"
import Ts1200 from  "../Images/Ts1200.jpg"
import Ts2000 from "../Images/Ts2000.jpg"
...
<h1 className="text-center m-auto">Tripod Turnstile</h1>
<br></br>
</div>
       ...
       <div className="card"> 
<br></br>
<h1 className="text-center">Tripod Turnstiles</h1>
...
<div class="row row-cols-1 row-cols-md-3 g-4 container">
 ...
 <div class="col">
     <div class="card h-100">
     <img src={Ts1200} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center">TS1200</h4>
         <p class="card-text">TS1200 Turnstiles are best in class with inbuilt RFID and Biometric access control systems. It is made of stainless steel SUS304 with elegant design and has high durability. This devices are easy to install and use. The system adopts standard electrical interfaces that could be integrated with variety of devices such as card and fingerprint systems. This is the right product for access control stations, docks, tourist attractions, checking tickets, convention and exhibition management etc. Also you can record staff attendance making it perfect for gymnasiums, factories, enterprises, public institutions, etc.</p>
         <Link to="/ts1200"><button id="smartbtn">Read more</button></Link>
     </div>
 ...
 <div class="col">
     <div class="card h-100">
     <img src={Ts2000} class="card-img-top" alt="..."></img>
     <div class="card-body">
         <h4 class="card-title text-center">TS2000</h4>
         <p class="card-text">TS2000 Turnstiles are best in class with inbuilt RFID and Biometric access control systems. It is made of stainless steel SUS304 with elegant design and has high durability. This devices are easy to install and use. The system adopts standard electrical interfaces that could be integrated with variety of devices such as card and fingerprint systems. This is the right product for access control stations, docks, tourist attractions, checking tickets, convention and exhibition management etc. Also you can record staff attendance making it perfect for gymnasiums, factories, enterprises, public institutions, etc.</p>
         <Link to="/ts2000"><button id="smartbtn">Read more</button></Link>
     </div>
